        ...
        overlay.handleFrameInput(
            {
                ...
                isActive: () => true,
                isSlotInRect: (_slot: number, rect: Rect2i) => rect.isContainingXY(swatch.x + 1, swatch.y + 1),
        ...
        overlay.handleFrameInput(
            {
                ...
                isSlotInRect: (_slot: number, rect: Rect2i) => rect.isContainingXY(track.x + 1, track.y + 1),
                getScrollDelta: () => 0,
