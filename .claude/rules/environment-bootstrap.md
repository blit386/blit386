---
paths: [scripts/session-start-bootstrap.sh, .claude/settings.json, .devcontainer/devcontainer.json]
---
...
The same script is wired into two places, both pointing at this one file so the bootstrap logic is never duplicated:
