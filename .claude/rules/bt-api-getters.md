...
| Runtime state                                    | `activeBackend`, `camera`, `palette`, `isAudioUnlocked`, `isMusicPlaying`, `screenOrientation` (`activeBackend` / `screenOrientation` `null` before init / when unavailable) |
