...
- `docs-site`, `kit`, `create-blit386` have no MCP security preflight – skip straight to step 3.
...
- Execute `pnpm run security:audit` (pnpm audit) in the package (root-level for `kit` / `create-blit386`)
