...
- Execute `pnpm run spellcheck` to check `src//*.{ts,md,mdx,mdc}`, `docs//*.{md,mdx,mdc}`, and `README.md`
...
- Files checked: `src//*.{ts,md,mdx,mdc}`, `docs//*.{md,mdx,mdc}`, `README.md` (see `package.json` `spellcheck` script)
