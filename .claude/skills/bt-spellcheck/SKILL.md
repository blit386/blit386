...
- Execute `pnpm run spellcheck` to check `src/**/*.{ts,md,mdx}`, `docs/**/*.{md,mdx}`, and `README.md`
...
- Files checked: `src/**/*.{ts,md,mdx}`, `docs/**/*.{md,mdx}`, `README.md` (see `package.json` `spellcheck` script)
