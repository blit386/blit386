...
| How do I get seeded / deterministic random numbers?                                                                       | `src/utils/Random.ts` (exported `Random` class); coordinate hashes in `src/utils/hash.ts` (`hash1i`/`hash2i`/`hash3i` + float forms); `docs/api-random.md`                                                                                                                                                                                                                                                                            |
