...
> [!TIP] You're reading the raw source on GitHub. The same page lives at https://blit386.dev/docs/api/core, typeset like
> an actual docs site and easier on the eyes. Probably the nicer place to read it, but same words either way.
