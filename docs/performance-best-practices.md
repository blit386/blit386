...
> https://blit386.dev/docs/performance/best-practices, typeset like an actual docs site and easier on the eyes. Probably
> the nicer place to read it, but same words either way.
